...
'admin.dashboard','admin.users.index','admin.roles.index','storage.local',);
        registerArgumentsSet('views', 
'api.api-token-manager','api.index','app.admin.dashboard.index','app.admin.roles.index','app.admin.users.index',
'app.dashboard.index','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.two-factor-challenge','auth.verify-email','components.action-message','components.action-section',
...
'components.breadcrumb-current-item','components.breadcrumb-item','components.button','components.checkbox','components.confirmation-modal',
...
'components.select','components.sidebar-nav-group','components.sidebar-nav-link','components.switchable-locale','components.switchable-team',
'components.validation-errors','components.welcome','dashboard','emails.team-invitation','guest.homepage.index',
'layouts.app','layouts.guest','layouts.inc.breadcrumb','layouts.inc.flash-messages','layouts.inc.footer',
'layouts.inc.header','livewire.app.admin.roles.role-management-component','livewire.app.admin.user.user-management-component','livewire.app.profile.manage-preferred-locale-component','livewire.inc.search-box',
'livewire.inc.sorting-th','livewire.layout.app-navigation','livewire::bootstrap','livewire::simple-bootstrap','livewire::simple-tailwind',
'livewire::tailwind','navigation-menu','policy','profile.delete-user-form','profile.logout-other-browser-sessions-form',
...
'terms','vendor.livewire.bootstrap','vendor.livewire.simple-bootstrap','vendor.livewire.simple-tailwind','vendor.livewire.tailwind',
...
'roles.index.edit_role','roles.index.delete_role','roles.index.confirm_delete_role','roles.index.flash_messages.delete_error','teams.pages.team_settings.headline',
'teams.pages.create_new_team.headline','teams.update_team_name_form.title','teams.update_team_name_form.description','teams.update_team_name_form.fields.team_owner','teams.update_team_name_form.fields.team_name',
'teams.team_member_manager.add_member.title','teams.team_member_manager.add_member.description','teams.team_member_manager.add_member.info','teams.team_member_manager.add_member.messages.user_not_found','teams.team_member_manager.add_member.messages.belongs_to_team',
'teams.team_member_manager.add_member.messages.user_already_invited','teams.team_member_manager.fields.email','teams.team_member_manager.fields.role','teams.team_member_manager.pending_invitations.title','teams.team_member_manager.pending_invitations.description',
'teams.team_member_manager.team_members.title','teams.team_member_manager.team_members.description','teams.team_member_manager.manage_role.title','teams.team_member_manager.leave_team.title','teams.team_member_manager.leave_team.description',
'teams.team_member_manager.remove_team_member.title','teams.team_member_manager.remove_team_member.description','teams.team_member_manager.remove_team_member.messages.owner','teams.delete_team_form.title','teams.delete_team_form.description',
'teams.delete_team_form.warning','teams.delete_team_form.confirmation','teams.delete_team_form.action','teams.create_team_form.title','teams.create_team_form.description',
'teams.create_team_form.fields.team_owner','teams.create_team_form.fields.team_name','users.index.title','users.index.headline','users.index.meta_description',
'users.index.table.name','users.index.table.email','users.index.table.role','users.index.table.no_items','users.index.table.select_role',
'users.index.form.name','users.index.form.email','users.index.form.role','users.index.validation.name.required','users.index.validation.name.string',
'users.index.validation.name.max','users.index.validation.email.required','users.index.validation.email.string','users.index.validation.email.email','users.index.validation.email.max',
'users.index.validation.email.unique','users.index.validation.role.required','users.index.validation.role.numeric','users.index.validation.role.exists','users.index.create_user',
'users.index.edit_user','users.index.delete_user','users.index.confirm_delete_user','welcome.headline','welcome.description',
'welcome.documentation.title','welcome.documentation.description','welcome.documentation.link','welcome.laracasts.title','welcome.laracasts.description',
'welcome.laracasts.link','welcome.tailwind.title','welcome.tailwind.description','welcome.authentication.title','welcome.authentication.description',);
