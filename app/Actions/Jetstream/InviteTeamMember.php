...
final readonly class InviteTeamMember implements InvitesTeamMembers
{
    ...
    private function validate(Team $team, string $email, ?string $role): void
    {
        Validator::make([
            ...
            'email.unique' => __('teams.team_member_manager.add_member.messages.user_already_invited'),
        ])->after(
     ...
     *
     * @return array<string, \Illuminate\Contracts\Validation\Rule|array<array-key, mixed>|string>
     */
